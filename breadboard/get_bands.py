...
def main(sensor,proc):
    ...
    if sensor == 'OLCI':
        ...
        bands_corr =       [400,412,443,490,510,560,620,665,674,681,    754,            779,865,885]#,        1020] # CARE should be included in bands_forwardNN 
        bands_forwardNN =  [400,412,443,490,510,560,620,665,674,681,709,754,            779,865,885,       1020]
        bands_backwardNN = [400,412,443,490,510,560,620,665,674,681,709,754,            779,865,885,       1020]
    ...
    return(bands_sat, bands_rw, bands_corr, bands_chi2, bands_forwardNN, bands_backwardNN, bands_abs)
